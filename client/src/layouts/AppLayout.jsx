  ...
  return (
    <div className="min-h-[100dvh] w-full overflow-x-clip bg-zinc-950 text-zinc-100">
      {/* ✅ Sidebar renders once:
          - Desktop: fixed left (inside Sidebar.jsx)
          - Mobile: drawer overlay (inside Sidebar.jsx)
      */}
      <Sidebar mobileOpen={mobileOpen} onClose={() => setMobileOpen(false)} />

      {/* ✅ Main area must leave space for desktop fixed sidebar */}
      <div className="relative min-h-[100dvh] w-full overflow-x-clip md:pl-[310px]">
        ...
        {/* ✅ Sticky Topbar: keep it under mobile drawer (drawer uses z-[9999]) */}
        <div
          className={[
            "relative z-40",
            "sticky top-0",
        ...
        >
          {/* Topbar can ignore these props if it doesn't use them */}
          <Topbar
