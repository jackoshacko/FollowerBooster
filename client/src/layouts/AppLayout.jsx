...
export default function AppLayout() {
  // ✅ hard reset: ako je nekad ostao body lock (sidebar/modal), vrati ga čim layout mounta
  useEffect(() => {
  ...
  return (
    <div className="min-h-[100dvh] w-full overflow-x-clip bg-zinc-950 text-zinc-100">
      <div className="flex min-h-[100dvh] w-full overflow-x-clip">
        {/* ✅ BITNO: Sidebar se NE mountuje na telefonu (nema hookova, nema fetch race) */}
        ...
        <div className="relative flex min-h-[100dvh] min-w-0 flex-1 flex-col overflow-x-clip isolate">
          ...
          {/* ✅ Sticky držimo ovde (SAMO JEDNOM), Topbar više nije sticky */}
          <div
            className={[
              "relative z-40",
              "sticky top-0",
